    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10">
        <div class="row mb-2">
            ...
            <form method="POST"  name="bookingForm" action="{{ route('booking.process')}}" >
                @csrf
                    Start Date: <input class="border py-2 px-1 mx-2" type="date" placeholder="Start Time....." id="startDate" name="start_date" onchange="updateStartDate()" requried>
                    End Date:<input class="border py-2 px-1 mx-2" type="date" placeholder="End Time......" id="endDate" name="end_date" onchange="calcHours()" requried>
                    <input type="hidden" id="location_id" name="location_id"/>

                    <button type="submit" id="submitBooking" name="submitBooking" height=44px width=120px >Book</button>
