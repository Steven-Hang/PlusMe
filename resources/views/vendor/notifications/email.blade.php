...
<body>
  <center>
    <table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" id="bodyTable" style="" width="100%">
      <tr>
        <td align="center" id="bodyCell" style="" valign="top">
          <!-- BEGIN TEMPLATE // -->
          <!--[if gte mso 9]>
 ...
 font-weight: normal; text-decoration: none" target="_blank" title="PlusMe car share">
                                  <img align="none" alt="." width="32" height="32" src="{{URL::asset('/css/images/orangelogo.png')}}" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 text-decoration: none; height: auto; width: 32px; height: 32px; margin: 0px;" />
 <img align="none" alt="PlusMe" height="32" src="{{URL::asset('/css/images/plusme.png')}}" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 text-decoration: none; height: auto; width: 107px; height: 32px; margin: 0px;" />
                                </a>
                              </td>
                            </tr>
                          </tbody>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #ff9933;
 ...
 0; text-align: left; width: 100%; font-size: 16px; font-weight: bold; '>What is PlusMe?</h3>
 ...
 Helvetica, sans-serif; font-size: 12px;" valign="top">
                                <div style="text-align: center;">Made with sleepless nights
                                  <a href="{{ url('/') }}" style="mso-line-height-rule: exactly; -ms-text-size-adjust: 100%;
 ...
 font-weight: normal; text-decoration: none; color:#7F6925;" target="_blank" title="Noun Project - Icons for Everything">PlusMe</a> - Jiawei Guo, Steven Hang, Omer Khan, Yuxuan Cheng, Brian Chen</div>
                              </td>
                            </tr>
                            <tbody></tbody>
                          </tbody>
